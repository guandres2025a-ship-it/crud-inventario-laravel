<div class="p-6 lg:p-8 bg-white/50 border-b border-gray-100">
    <x-application-logo class="block h-12 w-auto text-premium-600" />

    <h1 class="mt-8 text-3xl font-display font-medium text-slate-900">
        Welcome to your <span class="text-premium-600">Premium App</span>!
    </h1>

    <p class="mt-6 text-slate-600 leading-relaxed text-lg">
        Manage your clothes inventory with style and ease. This application has been enhanced to provide a superior user
        experience.
    </p>
</div>

<div class="bg-slate-50/50 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
